...
oatmeal = Cookie.new("Oatmeal Raisin", "A classic oatmeal raisin cookie with hints of browned butter, dark rum and cinnamon with a chewy texture. Packed with minced walnuts and raisins.", "oatmeal.jpeg")
...
family_cake = Cake.new("Summer Cake", "A family recipe - the cake itself is flavored with a dry Chardonnay, layered with fresh berries and vanilla custard, and encased in fresh whipped cream. It's light and subtle, and not too sweet.", "familycake.jpg")

apple_cake = Cake.new("Apple Bundt Cake", "The kind of cake one can eat guiltlessly for breakfast (or any time of day). This rustic budnt has three layers of cinnamon-spiced apples hiding within cake which is subtly flavored with the barest hint of citrus. Dairy-free.", "apple.jpg", "$6.50")

blackout = Cake.new("Brooklyn Blackout Cake", "A Brooklyn classic handed down through the ages. Ebinger's recipe has been recreated many times - but if any can hold a candle to the original remains a contentious topic. We gave it our all though; and if it's not quite as good as your memories of the classic (and when is it ever?) - at least you still have cake. A three-tiered devil’s food cake layered with chocolate pudding, slicked with dark chocolate frosting, and topped with additional devil’s food crumbs.", "blackout.jpg")
